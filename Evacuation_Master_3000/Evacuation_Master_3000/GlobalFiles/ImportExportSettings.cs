...
namespace Evacuation_Master_3000
{
    public static class ImportExportSettings
    {
        ...
        /// <summary>
        ///     Converts X, Y and Z coordinates to a string in the form of GridKeyFormat.
        /// </summary>
        /// <param name="x">The X-coordinate</param>
        /// <param name="y">The Y-coordinate</param>
        /// <param name="z">The Z-coordinate, aka floorlevel</param>
        /// <returns>Returns a string with X, Y and Z values in the form of GridKeyFormat.</returns>
        public static string Coordinate(int x, int y, int z)
        {
            return string.Format(GridKeyFormat, x, y, z);
        }
        /// <summary>
        /// Converts the given tile's X, Y and Z coordinates, to a string in the form of GridKeyFormat.
        /// </summary>
